...
- [ ] Базовые типы определены и документированы
- [ ] Система промптов спроектирована
- [ ] ConfigManager API определен
- [ ] CLI команды имеют четкую сигнатуру
- [ ] Пример использования в yandex-tracker написан
- [ ] Документ `API_DESIGN.md` создан
- [ ] Draft файлы созданы
