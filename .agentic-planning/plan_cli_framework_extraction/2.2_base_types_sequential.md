...
- [x] `src/types.ts` создан с базовыми типами
- [x] `src/connectors/base/connector.interface.ts` создан
- [x] `src/connectors/base/base-connector.ts` создан
- [x] Exports настроены
- [x] Базовые тесты написаны
- [x] `npm run build` проходит
- [x] `npm run typecheck` проходит
- [x] `npm run test` проходит (20/20 тестов)

---

## Критерии готовности

- [x] Все базовые типы определены
- [x] Generic параметр TConfig работает корректно
- [x] Тесты проходят (20/20)
- [x] TypeScript compilation успешен
- [x] Нет линтинг ошибок
