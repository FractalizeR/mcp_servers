...
- [x] `file-based-connector.ts` создан
- [x] Все 5 коннекторов перенесены и адаптированы
- [x] `ConnectorRegistry` создан
- [x] Barrel exports настроены
- [x] Unit тесты для всех коннекторов написаны
- [x] `npm run build` проходит
- [x] `npm run test` проходит (31 passed)
...
- [x] Все коннекторы работают с generic типами
- [x] Нет зависимостей от yandex-tracker
- [x] Registry не содержит автоматической регистрации
- [x] Тесты покрывают базовую функциональность (31 тестов)
- [x] TypeScript compilation успешен
- [x] Все exports работают корректно
