...
**Примечание:** Полное покрытие тестами (operations, tools, integration, smoke) отложено на будущие итерации. Текущие 11 unit-тестов для OAuth client обеспечивают базовую проверку функциональности.
