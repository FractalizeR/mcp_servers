...
- [ ] 5 date-based tools созданы
- [ ] 4 helper tools созданы (ping, search_tools, 2 GTD)
- [ ] tool-definitions.ts содержит все 25 tools
- [ ] Metadata правильно категоризирует tools
