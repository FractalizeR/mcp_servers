...
- [x] Task entity создан с unknown fields и checklist items
- [x] DTOs созданы (Create, Update с checklist support)
- [x] 6 operations созданы
- [x] GetTasksOperation использует ParallelExecutor
- [x] Кеш инвалидируется при мутациях
