...
- [x] package.json корректный, npm install успешен
- [x] tsconfig.json настроен, пути работают
- [x] constants.ts экспортирует константы
- [x] config-loader.ts загружает конфигурацию
