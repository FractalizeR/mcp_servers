...
2. **Создай детальный план** в `.agentic-planning/plan_{краткое_описание}/`
   - Структура: `1.1_stage_title.md`, `1.2_stage_title.md`, `2.1_stage_title.md`
   - Формат: Markdown с чек-листами и описанием шагов
   - Пример: `.agentic-planning/plan_refactor_tools/1.1_create_base_classes.md`
