...
**ВАЖНО:** Лимиты форматирования (commitlint):
- ✅ **Максимальная длина строки в body:** 100 символов
- ✅ Переносы строк: используй для длинных строк (не `\n`, а реальные переносы)
- ✅ Заголовок: без ограничений (но разумно ≤72 символа)
- ⚠️ Если commitlint падает с ошибкой `body-max-line-length` — разбей длинные строки
