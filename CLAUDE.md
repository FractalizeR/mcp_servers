...
### Лимиты размера (автоматическая проверка)

- `CLAUDE.md` ≤ 250 строк — actionable правила, НЕ примеры >5 строк
- `ARCHITECTURE.md` ≤ 400 строк — концепции, НЕ примеры >10 строк
