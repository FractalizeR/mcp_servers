 ...
 * позже эмпирически на TickTick `complete_task`, см. заголовок
 ...
 *   дефект, который пропускала проверка до привязки к цели (TickTick
...
describe('findUnreachableLeaves', () => {
  ...
  describe('привязка к ЦЕЛЕВОМУ запросу (регрессия TickTick complete_task)', () => {
