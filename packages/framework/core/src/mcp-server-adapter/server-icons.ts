 ...
 * 2026-07-28). Одна и та же иконка для всех серверов (Трекер/Вики/TickTick):
 * это identity издателя (FractalizeR), а не иконка домена задачи, поэтому
 * живёт в framework, а не дублируется в трёх пакетах серверов.
 *
