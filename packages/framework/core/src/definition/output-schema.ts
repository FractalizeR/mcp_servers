 ...
 *
 * Пакет 3.1.G: до этого пакета серверы, работая параллельно и без права
 * трогать framework, независимо изобрели один и тот же хелпер под разными
 * именами в разных пакетах. Совпадение способа — признак
