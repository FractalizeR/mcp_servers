 ...
 *
 * Символы принадлежат composition-root и не покидают его: слой facade инжектит
 * классы операций и контейнеров напрямую (`@inject(GetTaskOperation)`), как в
 * tracker/wiki. Class-based биндинги заводятся рядом с symbol-based в
 * `container.ts` (двойная регистрация).
 */
