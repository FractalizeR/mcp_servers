 ...
 */
export const GetTasksDueTomorrowOutputDataSchema = z.object({
  date: z.string(),
  total: z.number(),
 ...
 */
export const GET_TASKS_DUE_TOMORROW_OUTPUT_SCHEMA = buildSuccessOutputSchema(
  GetTasksDueTomorrowOutputDataSchema
);
