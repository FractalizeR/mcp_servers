 ...
 *
 * Очередь и участники из базы исключены: состав тела у создания и правки разный.
 * Очередь и там и там — `queues: string` (ключ одной очереди), но у правки к ней
 * добавлен непроверенный `teamUserIds` (см. `update-project.schema.ts`).
 */
