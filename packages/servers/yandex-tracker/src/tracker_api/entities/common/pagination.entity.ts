...
export interface PaginationMeta {
   ...
   * обе стороны: подтверждено вживую на v2, что `/issues/{id}/checklistItems`
   * игнорирует `perPage` (запрошен `perPage=1`, получено 4 элемента). После
   * миграции 4.1 путь ходит на v3 — на v3 наблюдение не переснималось.
   *
