...
export const KNOWN_MUTATING_REQUESTS: readonly KnownRequest[] = [
  ...
  },
  {
    ...
    method: 'post',
    path: `/v2/issues/${SANDBOX_ISSUE}/attachments`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'delete_attachment',
    method: 'delete',
    path: `/v2/issues/${SANDBOX_ISSUE}/attachments/9`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'add_checklist_item',
    method: 'post',
    path: `/v2/issues/${SANDBOX_ISSUE}/checklistItems`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'update_checklist_item',
    method: 'patch',
    path: `/v2/issues/${SANDBOX_ISSUE}/checklistItems/3`,
    expectation: 'allowed-in-sandbox',
  },
  {
  ...
  },
  {
    tool: 'add_worklog',
    method: 'post',
    path: `/v2/issues/${SANDBOX_ISSUE}/worklog`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'update_worklog',
    method: 'patch',
    path: `/v2/issues/${SANDBOX_ISSUE}/worklog/5`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'delete_worklog',
  ...
  },
  {
    ...
    method: 'post',
    path: '/v2/bulkchange/_transition',
  ...
  // Класс A' — сущности, локализованные в самой песочной очереди (6 запросов).
  {
    ...
    method: 'post',
    path: `/v2/queues/${SANDBOX_QUEUE}/components`,
    expectation: 'allowed-in-sandbox',
  },
  {
    tool: 'update_component',
    method: 'patch',
    path: `/v2/components/${SANDBOX_COMPONENT}`,
    expectation: 'allowed-in-sandbox',
  },
  {
  ...
  { tool: 'create_project', method: 'post', path: '/v2/projects', expectation: 'denied' },
  { tool: 'update_project', method: 'patch', path: '/v2/projects/11', expectation: 'denied' },
  { tool: 'delete_project', method: 'delete', path: '/v2/projects/11', expectation: 'denied' },
  { tool: 'create_global_field', method: 'post', path: '/v2/fields', expectation: 'denied' },
  { tool: 'update_global_field', method: 'patch', path: '/v2/fields/f1', expectation: 'denied' },
  { tool: 'delete_global_field', method: 'delete', path: '/v2/fields/f1', expectation: 'denied' },
  ...
  { tool: 'create_board', method: 'post', path: '/v2/boards', expectation: 'denied' },
  { tool: 'update_board', method: 'patch', path: '/v2/boards/b1', expectation: 'denied' },
  { tool: 'delete_board', method: 'delete', path: '/v2/boards/b1', expectation: 'denied' },
  {
  ...
  { tool: 'create_sprint', method: 'post', path: '/v2/sprints', expectation: 'denied' },
  { tool: 'update_sprint', method: 'patch', path: '/v2/sprints/s1', expectation: 'denied' },
  {
