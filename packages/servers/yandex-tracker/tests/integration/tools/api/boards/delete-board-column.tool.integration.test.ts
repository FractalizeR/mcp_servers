 ...
 * реально ходит в `/v3/...`. Расхождение версии — известная аномалия
 * (`tests/TESTING_STRATEGY.md` §2: «доски и колонки в разных версиях»), не
 * чинится в этом пакете, см. отчёт P1.
 */
