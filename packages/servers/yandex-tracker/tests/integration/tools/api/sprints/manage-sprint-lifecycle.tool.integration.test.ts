/**
 * С-4/С-5 у `manage_sprint_lifecycle` в матрице — `живьём`: реестр
 * (`tests/coverage-exceptions/live-observations.ts`) несёт запись по прогону
 * `sweep7-2026-08-26` — `archive` спринта `236` (версия 3→4), `start` спринта `238`,
 * `delete` спринта `237`. Клетку производит реестр, а не этот
 ...
 *
 * Пути и версии сверены с официальной документацией Яндекс.Трекера —
