#!/usr/bin/env tsx
/**
 * Smoke-тест собранного бандла Yandex Tracker.
 *
...
await runSmokeTest({
  ...
  bundlePath: 'dist/yandex-tracker.bundle.cjs',
  baseEnv: {
  ...
  minExpectedTools: 10,
  requiredTools: ['fr_yandex_tracker_ping'],
  forbiddenTools: ['search_tools'],
  messages: {
    header: '🚀 Запуск smoke-теста MCP сервера...\n',
    startingServer: '1️⃣  Запуск сервера: node dist/yandex-tracker.bundle.cjs',
